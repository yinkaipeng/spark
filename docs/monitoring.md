...
<table class="table">
  ...
  <tr>
    <td><code>spark.hadoop.yarn.timeline.post.queue.limit</code></td>
    <td>100</td>
    <td>
    Limit on number of posts in the outbound queue. Wwhen exceeded
...
<table class="table">
  ...
  <tr>
    ...
    <tr>
    <td><code>spark.history.yarn.disable.liveness.checks</code></td>
    <td>false</td>
    <td>
      Flag to disable bonding to the YARN Resource Manager to check on the
      state of incompleted applications. Intended for testing.
    </td>
  </tr>
