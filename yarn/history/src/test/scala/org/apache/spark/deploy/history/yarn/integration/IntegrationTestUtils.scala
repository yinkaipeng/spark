...
private[yarn] trait IntegrationTestUtils {
  ...
  def appHistoryInfo(id: String,
      attempts: List[TimelineApplicationAttemptInfo]): ApplicationHistoryInfo = {
    new ApplicationHistoryInfo(id, id, attempts)
  }

  def appHistoryInfo(id: String,
      attempt: TimelineApplicationAttemptInfo): ApplicationHistoryInfo = {
    new ApplicationHistoryInfo(id, id, attempt :: Nil)
  }
  ...
  : ApplicationHistoryInfo = {
    ...
    new ApplicationHistoryInfo(id, id, List(attempt))
  }
  /**
  ...
  def awaitListingEntry(provider: YarnHistoryProvider,
      appId: String,
      attempts: Int,
      timeout: Long): ApplicationHistoryInfo = {
    def probe(): Outcome = {
  ...
  def lookupApplication(listing: Seq[ApplicationHistoryInfo], id: ApplicationId): ApplicationHistoryInfo = {
    lookupApplication(listing, id.toString)
  }

  def lookupApplication(listing: Seq[ApplicationHistoryInfo], id: String): ApplicationHistoryInfo = {
  ...
  def assertAppCompleted(info: ApplicationHistoryInfo, text: String = ""): Unit = {
    assert(isCompleted(info), s"$text $info not flagged as completed")
  }


  def assertCompletedAttempt(attempt: ApplicationAttemptInfo, text: String = ""): Unit = {
