...
import org.apache.spark.deploy.history.yarn.testtools.{HistoryServiceNotListeningToSparkContext, StubApplicationAttemptId, TimelineSingleEntryBatchSize}
...
class YarnHistoryProviderWindowSuite
  ...
  test("YarnHistoryProviderWindow") {
    ...
    try {
      ...
      historyService = startHistoryService(sparkCtx, expectedAppId1,
